<template>
  <div class="font-sans">
    ...
    >
      <button
        @click="sendWhatsApp"
        class="bg-green-500 hover:bg-green-600 text-white p-6 rounded-full shadow-lg transition-all duration-300 hover:scale-110 flex items-center justify-center"
