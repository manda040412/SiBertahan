<template>
  <div class="home font-bahnschrift">
    <section class="hero-section relative overflow-hidden py-16 md:py-24">
      <div class="absolute left-4 sm:left-6 md:left-12 top-4 sm:top-6 md:top-12 flex flex-col gap-2 sm:gap-3 md:gap-4 z-20">
        <a href="https://www.instagram.com/sibertahan" target="_blank" rel="noopener noreferrer" class="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full border border-gray-300 bg-white flex items-center justify-center hover:bg-gray-100 transition-all">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-700" fill="currentColor" viewBox="0 0 16 16">
        ...
        <a href="https://www.linkedin.com/company/sibertahan/" target="_blank" rel="noopener noreferrer" class="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full border border-gray-300 bg-white flex items-center justify-center hover:bg-gray-100 transition-all">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-700" fill="currentColor" viewBox="0 0 16 16">
      ...
      <div class="container max-w-[1600px] mx-auto px-6 relative z-10">
        <div class="flex flex-col items-center text-center pt-8 pb-16">
          ...
          <a href="https://wa.me/6281211120045" target="_blank" rel="noopener noreferrer" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-5 sm:py-3 sm:px-6 pr-3 sm:pr-4 rounded-full text-sm font-medium transition inline-flex items-center gap-2 sm:gap-3">
            CONTACT US
      ...
      <div class="absolute bottom-6 right-6 sm:bottom-10 sm:right-10 flex flex-col gap-1 sm:gap-2">
    ...
    <section class="recognition bg-[#001428] py-16 sm:py-20 md:py-24 relative overflow-hidden min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] z-50 flex items-center justify-center">
      ...
      <div class="absolute inset-x-0 top-[10%] sm:top-[15%] md:top-[30%] bottom-0 z-0">
      ...
      <div class="relative z-40 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 md:gap-12 py-8">
    ...
    <section class="about bg-gradient-to-b from-[#000203] via-[#000203] via-20% to-[#06305C] relative overflow-hidden py-12 md:py-24">
      ...
      <div class="absolute top-12 sm:top-20 md:top-1/2 md:-translate-y-1/2 left-1/2 -translate-x-1/2 z-20 flex flex-col w-full sm:w-[90%] md:w-[80%] lg:w-[880px] px-4 sm:px-0 justify-center">
        <p class="text-blue-400 text-xl sm:text-2xl md:text-3xl lg:text-4xl tracking-wider font-medium underline underline-offset-[15px] text-center sm:text-left">ABOUT US</p>
      ...
      <div class="container max-w-[1600px] mx-auto px-6 relative z-10 pt-40 sm:pt-48 md:pt-60 pb-12 md:pb-24">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center w-full">
          <div class="relative flex items-center justify-center w-full min-h-[300px] sm:min-h-[400px] md:min-h-[600px]">
          ...
          <div class="md:ml-1 w-full">
            <p class="text-gray-300 mb-6 md:mb-8 leading-relaxed text-base sm:text-lg md:text-2xl pt-0 md:pt-20 text-center md:text-left">
            ...
            <router-link to="/about" class="text-blue-400 hover:text-blue-300 inline-flex items-center group text-sm md:text-base justify-center w-full md:justify-start">
              Read more
        ...
        <div class="container mx-auto px-4 sm:px-6 md:px-12">
          <div class="relative">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between relative mb-8 md:mb-12">
              <p class="text-blue-400 text-lg sm:text-xl md:text-2xl tracking-wider font-medium underline underline-offset-[15px] text-center md:text-left lg:pl-10 mb-4 md:mb-0">
                OUR SERVICES
              </p>
              <div class="absolute right-[-600px] top-1/2 -translate-y-1/2 hidden lg:flex flex-col gap-[20px] z-0">
                <div class="relative flex items-center justify-end">
                  <div class="absolute right-[730px] w-[18px] h-[18px] bg-blue-500 rounded-full transform -translate-x-1/2"></div>
                  <div class="h-[6px] w-[750px] bg-blue-500"></div>
                </div>
                <div class="relative flex items-center justify-end">
                  <div class="absolute right-[780px] w-[28px] h-[28px] bg-blue-500 rounded-full transform -translate-x-1/2"></div>
            ...
            <h2 class="text-3xl sm:text-5xl md:text-6xl lg:text-7xl pb-12 md:pb-24 text-white leading-tight text-center mx-auto max-w-full md:max-w-[880px]">
          ...
          <div class="flex flex-col gap-8">
            <router-link to="/services-siberserang" class="block">
              <div class="solution-card bg-[#06305C]/80 p-6 sm:p-8 rounded-xl backdrop-blur-sm border-2 border-white/20 hover:border-blue-500/80 transition-all duration-300 shadow-[0_0_50px_0_rgba(0,0,0,0.5)] cursor-pointer">
                <div class="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 text-center md:text-left">
                  ...
                  <div class="flex-grow">
                    <h3 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 text-white underline decoration-2 underline-offset-[20px] md:underline-offset-[30px]">SIBER<span class="text-red-500">SERANG</span></h3>
            ...
            <router-link to="/services-siberpatuh" class="block">
              <div class="solution-card bg-[#06305C]/80 p-6 sm:p-8 rounded-xl backdrop-blur-sm border-2 border-white/20 hover:border-blue-500/80 transition-all duration-300 shadow-[0_0_50px_0_rgba(0,0,0,0.5)] cursor-pointer">
                <div class="flex flex-col md:flex-row-reverse items-center justify-center gap-6 md:gap-8 text-center md:text-right">
                  <div class="flex-shrink-0 w-40 h-40 sm:w-48 sm:h-48 md:w-60 md:h-60 lg:w-[300px] lg:h-[300px] flex items-center justify-center relative solution-image">
                    <div class="relative z-10 w-full h-full">
                  ...
                  <div class="flex-grow">
                    <h3 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 text-white underline decoration-2 underline-offset-[20px] md:underline-offset-[30px]">SIBER<span class="text-green-500">PATUH</span></h3>
                    <p class="text-gray-300 pt-4 sm:pt-6 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base md:text-lg">
            ...
            <router-link to="/services-siberjaga" class="block">
              <div class="solution-card bg-[#06305C]/80 p-6 sm:p-8 rounded-xl backdrop-blur-sm border-2 border-white/20 hover:border-blue-500/80 transition-all duration-300 shadow-[0_0_50px_0_rgba(0,0,0,0.5)] cursor-pointer">
                <div class="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 text-center md:text-left">
                  ...
                  <div class="flex-grow">
                    <h3 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4 text-white underline decoration-2 underline-offset-[20px] md:underline-offset-[30px]">SIBER<span class="text-blue-500">JAGA</span></h3>
                    <p class="text-gray-300 pt-4 sm:pt-6 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base md:text-lg">
    ...
    <section class="experts bg-gradient-to-tr from-[#D7E6FF] from-0% to-[#F4F7FF] to-40% text-[#00101f] py-12 md:py-20 relative">
      <div class="container px-4 sm:px-6 md:px-12 max-w-[1600px] mx-auto">
        ...
        <div class="py-12 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div class="relative text-center md:text-left">
            <p class="text-lg md:text-xl lg:text-2xl tracking-wider font-medium underline underline-offset-[15px] mb-4">
              WHO WE ARE
            </p>
            <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl py-4 sm:py-6 md:py-10">
              Certified Cyber Security Experts
            </h2>
            <p class="text-gray-600 pl-0 sm:pl-4 md:pl-10 text-base sm:text-lg md:text-xl lg:text-2xl mb-4 md:mb-6">
          ...
          <div class="flex justify-center mt-8 md:mt-0">
            <img src="../assets/shield.png" alt="Security Shield" class="max-w-full w-40 sm:w-60 md:w-80 lg:w-[400px]" />
          </div>
        </div>
        ...
        <div class="py-12 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div class="order-2 md:order-1 flex justify-center mt-8 md:mt-0">
            <img src="../assets/cloud.png" alt="Cloud Security" class="max-w-full w-40 sm:w-60 md:w-80 lg:w-[400px]" />
          </div>

          <div class="order-1 md:order-2 relative text-center md:text-left">
            <p class="text-lg md:text-xl lg:text-2xl tracking-wider font-medium underline underline-offset-[15px] mb-4">
              WHAT WE PROVIDE
            </p>
            <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl py-6 md:py-12">
              Deliver Cyber
              Security Intelligence
            </h2>
            <div class="absolute bg-gray-500 opacity-5 w-full max-w-sm sm:max-w-md md:max-w-lg h-24 sm:h-28 md:h-32 top-20 sm:top-24 md:top-32 left-1/2 -translate-x-1/2 md:left-4 md:translate-x-0"></div>
            <p class="text-gray-600 pl-4 sm:pl-6 md:pl-10 text-base sm:text-lg md:text-xl mb-4 md:mb-6 relative z-10">
        ...
        <div class="py-12 md:py-20">
          <div class="container mx-auto max-w-7xl px-4 sm:px-6">
            <div class="text-left mb-8 relative">
              <p class="text-sm sm:text-base md:text-lg pl-4 sm:pl-10 pb-2 text-center md:text-left">
                See our services and contact
              </p>
              <div class="absolute bg-gray-500 opacity-5 w-full max-w-[200px] sm:max-w-[300px] md:max-w-[400px] h-16 sm:h-20 md:h-24 top-10 sm:top-12 md:top-16 left-1/2 -translate-x-1/2 md:left-0 md:translate-x-0"></div>
              <h2 class="text-5xl sm:text-7xl md:text-8xl lg:text-[100px] xl:text-[120px] 2xl:text-[160px] leading-none text-[#00101f] relative z-10 text-center md:text-left">
        ...
        <div class="container mx-auto max-w-6xl px-4 sm:px-6">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div class="text-center md:text-left text-sm md:text-base">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 mb-2 sm:mb-3 md:mb-4 text-blue-600 mx-auto md:mx-0" fill="none" viewBox="0 0 24 24" stroke="black">
...
.hero-section {
  background: url('../assets/background.png') center/cover no-repeat; /* Changed 'bottom center' to 'center' for better mobile crop */
  min-height: 100vh; /* Adjusted for standard mobile height, was 150vh */
  position: relative;
}

/* Background image for recognition section adjusted for responsiveness */
.recognition .absolute.inset-x-0.top-\[10\%\] img { /* Adjusted top percentage */
  object-position: center; /* Generally better for mobile */
}
...
/* Global styles to hide scrollbars - Ensure this is in a global CSS file or your main App.vue */
/* If you use `:global()` then it should be in a <style> block without `scoped` attribute */
/* For a scoped style block, you'd target html, body directly if not using global */
html,
body {
